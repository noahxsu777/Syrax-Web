...
type User = { id: string; email: string | null; phone: string | null; name: string; createdAt: string; lastSignInAt: string | null; emailConfirmed: boolean; verified: boolean };
